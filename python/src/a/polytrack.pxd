...
cdef extern from "a/polytrack.h":
    ...
    a_float_t a_polytrack3_vec(const a_polytrack3_s *ctx, a_float_t dt)
    ...
    a_float_t a_polytrack5_vec(const a_polytrack5_s *ctx, a_float_t dt)
    ...
    a_float_t a_polytrack7_vec(const a_polytrack7_s *ctx, a_float_t dt)
