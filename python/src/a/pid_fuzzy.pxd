...
cdef extern from "a/pid_fuzzy.h":
    ...
    a_pid_fuzzy_s *a_pid_fuzzy_init(a_pid_fuzzy_s *ctx, unsigned int num)
    a_pid_fuzzy_s *a_pid_fuzzy_chan(a_pid_fuzzy_s *ctx, unsigned int num, a_float_t *out, a_float_t *fdb, a_float_t *tmp, a_float_t *err)
    a_pid_fuzzy_s *a_pid_fuzzy_rule(a_pid_fuzzy_s *ctx, unsigned int col, const a_float_t *mec, const a_float_t *mec,
