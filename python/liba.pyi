...
@overload
def new_real(x: Iterable[float]) -> array[float]: ...
@overload
def new_real(x: int) -> array[float]: ...
@overload
...
def real_sum(x: Iterable[float]) -> float: ...
def real_sum1(x: Iterable[float]) -> float: ...
def real_sum2(x: Iterable[float]) -> float: ...
def real_mean(x: Iterable[float]) -> float: ...
...
class trajpoly3:
    ...
    def acc(self, x: float) -> float: ...
    @property
    def c0(self) -> array[float]: ...
    @property
    def c1(self) -> array[float]: ...
    @property
    def c2(self) -> array[float]: ...
