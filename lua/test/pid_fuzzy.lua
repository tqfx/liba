...
assert(type(a.pid_fuzzy.set_block(ctx, 2)) == "userdata")
...
ctx:rule(me, mec, mkp, mki, mkd):kpid(3, 2, 1):set_block(2):set_opr(a.pid_fuzzy.EQU):zero()
