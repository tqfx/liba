...
test.dir(getmetatable(a.pid_fuzzy))
...
assert(type(a.pid_fuzzy.set_joint(ctx, 2)) == "userdata")
assert(type(a.pid_fuzzy.off(ctx, 1, 0)) == "number")
...
ctx:rule(me, mec, mkp, mki, mkd):kpid(3, 2, 1):set_joint(2):op(a.pid_fuzzy.EQU):zero()
