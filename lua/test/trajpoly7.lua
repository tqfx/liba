...
test.dir(getmetatable(a.trajpoly7))
local ctx = a.trajpoly7.new(1, 0, 1, 0, 1, 0, 1, 0, 1)
assert(ctx)
test.dir(getmetatable(ctx))
assert(type(a.trajpoly7.pos(ctx, 0.5)) == "number")
assert(type(a.trajpoly7.vel(ctx, 0.5)) == "number")
assert(type(a.trajpoly7.acc(ctx, 0.5)) == "number")
assert(type(a.trajpoly7.jer(ctx, 0.5)) == "number")
