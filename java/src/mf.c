...
JNIEXPORT void JNICALL Java_liba_mf_INIT(JNIEnv *jenv, jclass jcls)
{
...
JNIEXPORT jdouble JNICALL Java_liba_mf_gauss(JNIEnv *jenv, jclass jcls, jdouble x, jdouble sigma, jdouble c)
{
    return (void)(jenv), (void)(jcls), a_mf_gauss(x, sigma, c);
}

JNIEXPORT jdouble JNICALL Java_liba_mf_gauss2(JNIEnv *jenv, jclass jcls, jdouble x, jdouble sigma1, jdouble c1, jdouble sigma2, jdouble c2)
{
    return (void)(jenv), (void)(jcls), a_mf_gauss2(x, sigma1, c1, sigma2, c2);
}

JNIEXPORT jdouble JNICALL Java_liba_mf_gbell(JNIEnv *jenv, jclass jcls, jdouble x, jdouble a, jdouble b, jdouble c)
{
    return (void)(jenv), (void)(jcls), a_mf_gbell(x, a, b, c);
}

JNIEXPORT jdouble JNICALL Java_liba_mf_sig(JNIEnv *jenv, jclass jcls, jdouble x, jdouble a, jdouble c)
{
    return (void)(jenv), (void)(jcls), a_mf_sig(x, a, c);
}

JNIEXPORT jdouble JNICALL Java_liba_mf_dsig(JNIEnv *jenv, jclass jcls, jdouble x, jdouble a1, jdouble c1, jdouble a2, jdouble c2)
{
    return (void)(jenv), (void)(jcls), a_mf_dsig(x, a1, c1, a2, c2);
}

JNIEXPORT jdouble JNICALL Java_liba_mf_psig(JNIEnv *jenv, jclass jcls, jdouble x, jdouble a1, jdouble c1, jdouble a2, jdouble c2)
{
    return (void)(jenv), (void)(jcls), a_mf_psig(x, a1, c1, a2, c2);
}

JNIEXPORT jdouble JNICALL Java_liba_mf_trap(JNIEnv *jenv, jclass jcls, jdouble x, jdouble a, jdouble b, jdouble c, jdouble d)
{
    return (void)(jenv), (void)(jcls), a_mf_trap(x, a, b, c, d);
}

JNIEXPORT jdouble JNICALL Java_liba_mf_tri(JNIEnv *jenv, jclass jcls, jdouble x, jdouble a, jdouble b, jdouble c)
{
    return (void)(jenv), (void)(jcls), a_mf_tri(x, a, b, c);
}

JNIEXPORT jdouble JNICALL Java_liba_mf_lins(JNIEnv *jenv, jclass jcls, jdouble x, jdouble a, jdouble b)
{
    return (void)(jenv), (void)(jcls), a_mf_lins(x, a, b);
}

JNIEXPORT jdouble JNICALL Java_liba_mf_linz(JNIEnv *jenv, jclass jcls, jdouble x, jdouble a, jdouble b)
{
    return (void)(jenv), (void)(jcls), a_mf_linz(x, a, b);
}

JNIEXPORT jdouble JNICALL Java_liba_mf_s(JNIEnv *jenv, jclass jcls, jdouble x, jdouble a, jdouble b)
{
    return (void)(jenv), (void)(jcls), a_mf_s(x, a, b);
}

JNIEXPORT jdouble JNICALL Java_liba_mf_z(JNIEnv *jenv, jclass jcls, jdouble x, jdouble a, jdouble b)
{
    return (void)(jenv), (void)(jcls), a_mf_z(x, a, b);
}

JNIEXPORT jdouble JNICALL Java_liba_mf_pi(JNIEnv *jenv, jclass jcls, jdouble x, jdouble a, jdouble b, jdouble c, jdouble d)
{
