...
def hash_bkdr(str: bytes, val: int) -> int: ...
def isqrt(x: int) -> int: ...
@overload
...
class crc8:
    POLY: int
    INIT: int
    def __init__(self, poly=POLY, big_endian=False) -> None: ...
...
class version:
    ...
    def __init__(self, major: int = 0, minor: int = 0, patch: int = 0, extra: int = 0) -> None: ...
