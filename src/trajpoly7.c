...
void a_trajpoly7_gen0(a_trajpoly7 *ctx, a_real ts,
                      a_real p0, a_real p1,
                      a_real v0, a_real v1,
                      a_real a0, a_real a1,
                      a_real j0, a_real j1)
{
    ...
    ctx->p[0] = p0;
    ctx->p[1] = v0;
    ctx->p[2] = a0 * (a_real)(1 / 2.0);
    ctx->p[3] = j0 * (a_real)(1 / 6.0);
    ctx->p[4] = (a_real)(1 / 6.0) *
                (_t1 * (-4 * j0 - j1) +
                 _t2 * (15 * a1 - 30 * a0) -
                 _t3 * (120 * v0 + 90 * v1) +
                 _t4 * p * 210);
    ctx->p[5] = (a_real)(1 / 2.0) *
                (_t2 * (2 * j0 + j1) +
                 _t3 * (20 * a0 - 14 * a1) +
                 _t4 * (90 * v0 + 78 * v1) -
                 _t5 * p * 168);
    ctx->p[6] = (a_real)(1 / 6.0) *
                (_t3 * (-4 * j0 - 3 * j1) +
                 _t4 * (39 * a1 - 45 * a0) -
                 _t5 * (216 * v0 + 204 * v1) +
                 _t6 * p * 420);
    ctx->p[7] = (a_real)(1 / 6.0) *
                (_t4 * (j0 + j1) +
                 _t5 * (a0 - a1) * 12 +
                 _t6 * (v0 + v1) * 60 -
                 _t7 * p * 120);
