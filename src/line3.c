                        ...
                        a_real *w1, a_point3 *p1, a_real *w2, a_point3 *p2)
{
    ...
    d12 = a_vector3_dot(&ctx->dir_, &rhs->dir_);
    if (A_ABS(d12) < 1 - A_REAL_EPS)
    {
        ...
        a_vector3_set(&p12, &ctx->org, &rhs->org);
        ...
        *w2 = (pv1 * d12 - pv2) * s;
        ...
        d12 = a_line3_limdist2(ctx, min1, max1, p2, &pv1, &pt1);
        if (d12 < res)
        {
            res = d12;
            *w1 = pv1;
    ...
    *w1 = min1;
    ...
    d12 = a_line3_limdist2(rhs, min2, max2, &pt1, &w12, &pt2);
    if (d12 < res)
    {
        res = d12;
        *w1 = max1;
    ...
    d12 = a_line3_limdist2(ctx, min1, max1, &pt2, &w12, &pt1);
    if (d12 < res)
    {
        res = d12;
        *w1 = w12;
