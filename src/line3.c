...
int a_line3_set1(a_line3 *ctx, a_point3 const *p, a_vector3 const *v)
{
    int rc = A_FAILURE;
...
int a_line3_set2(a_line3 *ctx, a_point3 const *p, a_point3 const *q)
{
    a_vector3 v;
    a_vector3_set(&v, p, q);
    return a_line3_set1(ctx, p, &v);
}
