...
int MAIN(int argc, char *argv[]) // NOLINT(misc-definitions-in-headers)
{
    ...
    if (argc > 1)
    {
        if (strstr(argv[1], "gauss2."))
        {
            e = A_MF_GAUSS2;
        }
        else if (strstr(argv[1], "gauss."))
        {
            e = A_MF_GAUSS;
        }
        else if (strstr(argv[1], "gbell."))
        {
            e = A_MF_GBELL;
        }
        else if (strstr(argv[1], "dsig."))
        {
            e = A_MF_DSIG;
        }
        else if (strstr(argv[1], "psig."))
        {
            e = A_MF_PSIG;
        }
        else if (strstr(argv[1], "sig."))
        {
            e = A_MF_SIG;
        }
        else if (strstr(argv[1], "trap."))
        {
            e = A_MF_TRAP;
        }
        else if (strstr(argv[1], "tri."))
        {
            e = A_MF_TRI;
        }
        else if (strstr(argv[1], "lins."))
        {
            e = A_MF_LINS;
        }
        else if (strstr(argv[1], "linz."))
        {
            e = A_MF_LINZ;
        }
