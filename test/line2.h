...
{
    {
        ...
        TEST_BUG(iseq(a_line2_max(&ctx), 5));
    ...
    }
    {
        ...
        a_line2_setv(&l1, &p, &u);
        a_line2_setv(&l2, &p, &u);
        TEST_BUG(a_line2_int1(&l1, 0, +1, &l2, 0, +1, &t1, &t2) == 2);
        TEST_BUG(a_line2_int1(&l1, -1, 0, &l2, 0, +1, &t1, &t2) == 1);
        TEST_BUG(iseq(t1, 0));
        TEST_BUG(iseq(t2, 0));
        a_line2_setv(&l2, &p, &v);
        TEST_BUG(a_line2_int1(&l1, -1, 0, &l2, -1, 0, &t1, &t2) == 1);
        TEST_BUG(iseq(t1, 0));
        TEST_BUG(iseq(t2, 0));
        a_line2_setv(&l2, &q, &u);
        TEST_BUG(a_line2_int1(&l1, 0, 10, &l2, 0, 10, &t1, &t2) == 0);
        a_line2_setv(&l2, &q, &v);
        TEST_BUG(a_line2_int1(&l1, 0, 10, &l2, 0, 10, &t1, &t2) == 1);
        ...
        TEST_BUG(a_line2_int0(&l1, 0, 10, &w, &t1) == 1);
        TEST_BUG(a_line2_int0(&l2, 0, 10, &w, &t2) == 1);
        a_line2_eval(&l1, t1, &p1);
        TEST_BUG(iseq(p1.x, w.x));
        TEST_BUG(iseq(p1.y, w.y));
        a_line2_eval(&l2, t2, &p2);
    ...
    }
    {
        ...
        s = a_line2_segdist2(&l1, -10, +10, &l2, -10, +10, &w1, &q1, &w2, &q2);
        ...
        a_line2_set_dir(&l2, 0, 1);
        s = a_line2_segdist(&l1, -10, +10, &l2, -10, +10, &w1, &q1, &w2, &q2);
