...
#define RAND__MAX 2147483647
static unsigned long rand__ = 1;
...
{
    rand__ = (rand__ * 1103515245 + 12345) % 2147483648;
    return (long)rand__;
}
...
int MAIN(int argc, char *argv[]) // NOLINT(misc-definitions-in-headers)
{
    ...
    for (unsigned int i = 0; i < 100; ++i)
    {
        ...
        a_float_t noise = (a_float_c(, rand_()) / RAND__MAX - A_FLOAT_C(0.5));
