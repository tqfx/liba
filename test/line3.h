...
int main(int argc, char *argv[]) /* NOLINT(misc-definitions-in-headers) */
{
    ...
    }
    {
        ...
        a_line3_setv(&l1, &p, &u);
        a_line3_setv(&l2, &p, &u);
        TEST_BUG(a_line3_int1(&l1, 0, +1, &l2, 0, +1, &t1, &t2) == 2);
        TEST_BUG(a_line3_int1(&l1, -1, 0, &l2, 0, +1, &t1, &t2) == 1);
        TEST_BUG(iseq(t1, 0));
        TEST_BUG(iseq(t2, 0));
        a_line3_setv(&l2, &p, &v);
        TEST_BUG(a_line3_int1(&l1, -1, 0, &l2, -1, 0, &t1, &t2) == 1);
        TEST_BUG(iseq(t1, 0));
        TEST_BUG(iseq(t2, 0));
        a_line3_setv(&l2, &q, &u);
        TEST_BUG(a_line3_int1(&l1, 0, 10, &l2, 0, 10, &t1, &t2) == 0);
        a_line3_setv(&l2, &q, &v);
        TEST_BUG(a_line3_int1(&l1, 0, 10, &l2, 0, 10, &t1, &t2) == 1);
        ...
        TEST_BUG(a_line3_int0(&l1, 0, 10, &w, &t1) == 1);
        TEST_BUG(a_line3_int0(&l2, 0, 10, &w, &t2) == 1);
        a_line3_eval(&l1, t1, &p1);
        TEST_BUG(iseq(p1.x, w.x));
        TEST_BUG(iseq(p1.y, w.y));
        TEST_BUG(iseq(p1.z, w.z));
    ...
    }
    {
        ...
        s = a_line3_segdist2(&l1, -10, +10, &l2, -10, +10, &w1, &q1, &w2, &q2);
        ...
        a_line3_set_dir(&l2, 0, 1, 0);
        s = a_line3_segdist(&l1, -10, +10, &l2, -10, +10, &w1, &q1, &w2, &q2);
