...
macro(warnings_flag_cc)
  foreach(arg ${ARGN})
    ...
    if(${found} GREATER -1)
      string(REPLACE ";" " " CMAKE_REQUIRED_FLAGS "${WARNINGS_CC}")
      check_c_compiler_flag(${arg} cc${var})
      if(cc${var})
        list_append(WARNINGS_CC ${arg})
      endif()
...
macro(warnings_flag_xx)
  foreach(arg ${ARGN})
    ...
    if(${found} GREATER -1)
      string(REPLACE ";" " " CMAKE_REQUIRED_FLAGS "${WARNINGS_XX}")
      check_cxx_compiler_flag(${arg} xx${var})
      if(xx${var})
        list_append(WARNINGS_XX ${arg})
      endif()
      set(CMAKE_REQUIRED_FLAGS)
    endif()
  endforeach()
...
function(target_compile_warnings)
  ...
  foreach(target ${ARGN})
    target_compile_options(${target} PRIVATE
      $<$<COMPILE_LANGUAGE:C>:${WARNINGS_CC}>
      $<$<COMPILE_LANGUAGE:CXX>:${WARNINGS_XX}>
    )
  endforeach()
endfunction()
