...
static JSValue liba_trajbell_get(JSContext *ctx, JSValueConst this_val, int magic)
{
    ...
    case 11: x = (double)self->jm; break;
    case 12: x = (double)self->am; break;
    case 13: x = (double)self->dm; break;
...
static JSCFunctionListEntry const liba_trajbell_proto[] = {
    ...
    JS_CGETSET_MAGIC_DEF("t", liba_trajbell_get, NULL, 0),
    JS_CGETSET_MAGIC_DEF("tv", liba_trajbell_get, NULL, 1),
    JS_CGETSET_MAGIC_DEF("ta", liba_trajbell_get, NULL, 2),
    ...
    JS_CGETSET_MAGIC_DEF("jm", liba_trajbell_get, NULL, 11),
    JS_CGETSET_MAGIC_DEF("am", liba_trajbell_get, NULL, 12),
    JS_CGETSET_MAGIC_DEF("dm", liba_trajbell_get, NULL, 13),
