...
static JSValue liba_trajpoly5_get(JSContext *ctx, JSValueConst this_val, int magic)
{
    ...
    switch (magic)
    {
    case trajpoly5_c0: return js_array_num_new(ctx, self->c, A_LEN(self->c));
    case trajpoly5_c1:
        a_trajpoly5_c1(self, c);
        return js_array_num_new(ctx, c, A_LEN(self->c) - 1);
    case trajpoly5_c2:
        a_trajpoly5_c2(self, c);
...
static JSCFunctionListEntry const liba_trajpoly5_proto[] = {
    ...
    JS_CGETSET_MAGIC_DEF("c0", liba_trajpoly5_get, NULL, trajpoly5_c0),
    JS_CGETSET_MAGIC_DEF("c1", liba_trajpoly5_get, NULL, trajpoly5_c1),
    JS_CGETSET_MAGIC_DEF("c2", liba_trajpoly5_get, NULL, trajpoly5_c2),
...
int js_liba_trajpoly5_init(JSContext *ctx, JSModuleDef *m)
{
    ...
    JS_NewClassID(rt, &liba_trajpoly5_class_id);
    JS_NewClass(rt, liba_trajpoly5_class_id, &liba_trajpoly5_class);
