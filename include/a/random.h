...
#ifndef LIBA_RANDOM_H
#define LIBA_RANDOM_H

#include "a.h"

/*!
 @ingroup liba
 @addtogroup a_random pseudorandom number generator
 @{
*/

/* clang-format off */
#define A_RANDOM_LCG48_INIT {A_U64_C(0x5DEECE66D), A_U16_C(0x0B), {A_U16_C(0x330E), A_U16_C(0xABCD), A_U16_C(0x1234)}}
/* clang-format on */

typedef struct a_random_lcg48 a_random_lcg48;
...
*/
A_EXTERN void a_random_lcg48_init(a_random_lcg48 *ctx, long x);
/*!
...
*/
A_EXTERN void a_random_lcg48_seed(a_random_lcg48 *ctx, a_u16 const x[3]);
/*!
...
*/
A_EXTERN A_NONULL((1, 2)) a_u64 a_random_lcg48_iter(a_random_lcg48 *ctx, a_u16 x[3]);
...
*/
A_EXTERN a_i32 a_random_lcg48i(a_random_lcg48 *ctx, a_u16 x[3]);
/*!
...
*/
A_EXTERN a_u32 a_random_lcg48u(a_random_lcg48 *ctx, a_u16 x[3]);
/*!
...
*/
A_EXTERN a_f64 a_random_lcg48f(a_random_lcg48 *ctx, a_u16 x[3]);
