...
/*!
 @brief compute LU decomposition of a square matrix with partial pivoting, PA=LU.
...
/*!
 @brief apply the permutation matrix P to an identity matrix I.
 ...
 @param[out] I the output matrix where the permuted identity matrix will be stored.
*/
A_EXTERN void a_linalg_plu_get_P(a_uint const *P, a_uint n, a_float *I);
