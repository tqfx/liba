...
/*!
 ...
 @details If \f$q_0>q_1\f$, then \f{aligned}{q_0=-q_0\\q_1=-q_1\\v_0=-v_0\\v_1=-v_1\f}
 ...
 3. Calculate the constant velocity phase \f[T_v=\frac{q_1-q_0}{v_m}
 ...
 b. If \f$T_a<0\f$, there is only acceleration phase, then \f$T_d=0\f$,\f$T_{dj}=0\f$,
 \f{aligned}{T_a&=2\cfrac{q_1-q_0}{v_1+v_0}\\
 T_{aj}&=\frac{j_m(q_1-q_0)-\sqrt{j_m(j_m(q_1-q_0)^2+(v_0-v_1)(v_1+v_0)^2)}}{j_m(v_1+v_0 )}\f}
...
/*!
 ...
 \f[
  q(t)=\begin{cases}
  q_0+v_0t+j_m\cfrac{t^3}{6},&t\in[0,T_{aj}]\\
  q_0+v_0t+\cfrac{a_m}{6}(3t^3-3tT_{aj}+T_{aj}^2),&t\in[T_{aj},T_a-T_{aj}]\\
  q_0+(v_m+v_0)\cfrac{T_a}{2}-v_m(T_a-t)+j_m\cfrac{(T_a-t)^3}{6},&t\in[T_a-T_{aj},T_a]\\
  q_0+(v_m+v_0)\cfrac{T_a}{2}+v_m(t-T_a),&t\in[T_a,T_a+T_v]\\
  q_1-(v_m+v_1)\cfrac{T_d}{2}+v_m(t-T+T_d)-j_m\cfrac{(t-T+T_d)^3}{6},&t\in[T-T_d,T-T_d+T_{dj}]\\
  q_1-(v_m+v_1)\cfrac{T_d}{2}+v_m(t-T+T_d)\\
  \quad+\cfrac{d_m}{6}\left(3(t-T+T_d)^2-3(t-T+T_d)T_{dj}+T_{dj}^2\right),&t\in[T-T_d+T_{dj},T-T_{dj}]\\
  q_1-v_1(T-t)-j_m\cfrac{(T-t)^3}{6},&t\in[T-T_{dj},T]
  \end{cases}
 \f]
