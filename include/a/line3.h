...
/*!
 @ingroup liba
 @addtogroup a_line3 three-dimensional line defined by an origin, a direction vector, and a length
 @{
*/
...
/*!
 ...
 @param[in] ctx points to an instance of the three-dimensional line
 @return the maximum length value
*/
A_INTERN a_real a_line3_max(a_line3 const *ctx);
/*!
...
/*!
 ...
 @param[in,out] ctx points to an instance of the three-dimensional line
 @param[in] x is the x-coordinate of the origin
 @param[in] y is the y-coordinate of the origin
 @param[in] z is the z-coordinate of the origin
*/
...
*/
A_INTERN void a_line3_set_max(a_line3 *ctx, a_real max);
...
/*!
 ...
 @param[in] z is Z component of the direction vector
...
/*!
 ...
 @param[in] z is Z coordinate of the target point
 @return error code value
  @retval <0 failure
  @retval 0 success
*/
...
/*!
 @brief compute the distance from a point to the infinite line.
 @param[in] ctx points to an instance of the three-dimensional line
...
/*!
 @brief compute the squared distance from a point to the infinite line.
 @param[in] ctx points to an instance of the three-dimensional line
 @param[in] rhs points to the point
...
*/
A_EXTERN a_real a_line3_segdist(a_line3 const *ctx, a_real min1, a_real max1,
...
*/
A_EXTERN a_real a_line3_segdist2(a_line3 const *ctx, a_real min1, a_real max1,
                                 a_line3 const *rhs, a_real min2, a_real max2,
                                 a_real *w1, a_point3 *p1, a_real *w2, a_point3 *p2);
...
*/
A_EXTERN int a_line3_int0(a_line3 const *ctx, a_real min, a_real max, a_point3 const *rhs, a_real *w);
/*!
 ...
 @return the intersection type
  ...
  @retval 0 no intersection
*/
A_EXTERN int a_line3_int1(a_line3 const *ctx, a_real min1, a_real max1,
                          a_line3 const *rhs, a_real min2, a_real max2,
                          a_real *w1, a_real *w2);

/*!
 @brief rotate a 3D line segment around an arbitrary axis defined by another line.
 @param[in] ctx points to an instance of the line segment
 @param[in] rhs points to the line defining the rotation axis and pivot point
...
*/
A_EXTERN void a_line3_rot_(a_line3 const *ctx, a_line3 const *rhs, a_real sin, a_real cos, a_line3 *res);
/*!
 @brief rotate a 3D line segment around an arbitrary axis defined by another line.
 @param[in] ctx points to an instance of the line segment
 @param[in] rhs points to the line defining the rotation axis and pivot point
...
/*!
 @brief instance structure for three-dimensional line defined by an origin, a direction vector, and a length
*/
struct a_line3
{
    a_point3 org; /*!< origin point of the line */
    a_vector3 dir_; /*!< normalized direction vector of the line */
    a_real max; /*!< maximum length of the line segment */
#if defined(__cplusplus)
    /*! @copybrief a_line3_set_max @see a_line3_set_max */
    A_INLINE void set_max(a_real max_) { max = max_; }
    /*! @copybrief a_line3_set_org @see a_line3_set_org */
    A_INLINE void set_org(a_real x, a_real y, a_real z)
    {
        a_line3_set_org(this, x, y, z);
    }
    /*! @copybrief a_line3_dir @see a_line3_dir */
    A_INLINE a_vector3 const &dir() const { return dir_; }
    /*! @copybrief a_line3_set_dir @see a_line3_set_dir */
    A_INLINE int set_dir(a_real x, a_real y, a_real z)
    {
        return a_line3_set_dir(this, x, y, z);
    }
    /*! @copybrief a_line3_tgt @see a_line3_tgt */
    A_INLINE void tgt(a_point3 &res) const { a_line3_tgt(this, &res); }
    /*! @copybrief a_line3_set_tgt @see a_line3_set_tgt */
    A_INLINE int set_tgt(a_real x, a_real y, a_real z)
    {
        return a_line3_set_tgt(this, x, y, z);
    }
    /*! @copybrief a_line3_setv @see a_line3_setv */
    A_INLINE int set(a_point3 const &p, a_vector3 const &v)
    {
        return a_line3_setv(this, &p, &v);
    }
    /*! @copybrief a_line3_set @see a_line3_set */
    A_INLINE int set(a_point3 const &p, a_point3 const &q)
    {
        return a_line3_set(this, &p, &q);
    }
    /*! @copybrief a_line3_eval @see a_line3_eval */
    A_INLINE void eval(a_real w, a_point3 &res) const
    {
        a_line3_eval(this, w, &res);
    }
    /*! @copybrief a_line3_parm @see a_line3_parm */
    A_INLINE a_real parm(a_point3 const &rhs) const
    {
        return a_line3_parm(this, &rhs);
    }
    /*! @copybrief a_line3_proj @see a_line3_proj */
    A_INLINE a_real proj(a_point3 const &rhs, a_point3 &res) const
    {
        return a_line3_proj(this, &rhs, &res);
    }
    /*! @copybrief a_line3_limparm @see a_line3_limparm */
    A_INLINE a_real limparm(a_real min_, a_real max_, a_point3 const &rhs) const
    {
        return a_line3_limparm(this, min_, max_, &rhs);
    }
    /*! @copybrief a_line3_limproj @see a_line3_limproj */
    A_INLINE a_real limproj(a_real min_, a_real max_, a_point3 const &rhs, a_point3 &res) const
    {
        return a_line3_limproj(this, min_, max_, &rhs, &res);
    }
    /*! @copybrief a_line3_dist @see a_line3_dist */
    A_INLINE a_real dist(a_point3 const &rhs) const
    {
        return a_line3_dist(this, &rhs);
    }
    /*! @copybrief a_line3_dist2 @see a_line3_dist2 */
    A_INLINE a_real dist2(a_point3 const &rhs) const
    {
        return a_line3_dist2(this, &rhs);
    }
    /*! @copybrief a_line3_limdist @see a_line3_limdist */
    A_INLINE a_real limdist(a_real min_, a_real max_, a_point3 const &rhs, a_real &w, a_point3 &p)
    {
        return a_line3_limdist(this, min_, max_, &rhs, &w, &p);
    }
    /*! @copybrief a_line3_limdist2 @see a_line3_limdist2 */
    A_INLINE a_real limdist2(a_real min_, a_real max_, a_point3 const &rhs, a_real &w, a_point3 &p)
    {
        return a_line3_limdist2(this, min_, max_, &rhs, &w, &p);
    }
    /*! @copybrief a_line3_segdist @see a_line3_segdist */
    A_INLINE a_real segdist(a_real min1, a_real max1, a_line3 const &rhs, a_real min2, a_real max2,
                            a_real &w1, a_point3 &p1, a_real &w2, a_point3 &p2) const
    {
        return a_line3_segdist(this, min1, max1, &rhs, min2, max2, &w1, &p1, &w2, &p2);
    }
    /*! @copybrief a_line3_segdist2 @see a_line3_segdist2 */
    A_INLINE a_real segdist2(a_real min1, a_real max1, a_line3 const &rhs, a_real min2, a_real max2,
                             a_real &w1, a_point3 &p1, a_real &w2, a_point3 &p2) const
    {
        return a_line3_segdist2(this, min1, max1, &rhs, min2, max2, &w1, &p1, &w2, &p2);
    }
    /*! @copybrief a_line3_int0 @see a_line3_int0 */
    A_INLINE int int0(a_real min_, a_real max_, a_point3 const &rhs, a_real &w) const
    {
        return a_line3_int0(this, min_, max_, &rhs, &w);
    }
    /*! @copybrief a_line3_int1 @see a_line3_int1 */
    A_INLINE int int1(a_real min1, a_real max1, a_line3 const &rhs, a_real min2, a_real max2,
                      a_real &w1, a_real &w2) const
    {
        return a_line3_int1(this, min1, max1, &rhs, min2, max2, &w1, &w2);
    }
    /*! @copybrief a_line3_rot_ @see a_line3_rot_ */
    A_INLINE void rot(a_line3 const &rhs, a_real sin, a_real cos, a_line3 &res) const
    {
        a_line3_rot_(this, &rhs, sin, cos, &res);
    }
    /*! @copybrief a_line3_rot @see a_line3_rot */
